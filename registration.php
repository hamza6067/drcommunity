            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 form">
                        ...
                        <a href="doctor.php" style="color:white; margin-left:140px; margin-top:50px;font-size:25px;">Register as a Doctor</a><br/><br/>
                            <a href="patient.php" style="color:white;margin-left:140px;margin-top:50px;font-size:25px;">Register as a Patient</a>
                            </div>
                        <div class="form-group" style="text-align:center;margin-top:30px;">
                                <span style="color:aqua;">already registered?<a href="login.php"> Click here to login</a></span>
                                </div>
